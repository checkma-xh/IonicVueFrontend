        ...
        <ion-content :fullscreen="true" class="ion-padding">
            ...
            <div id="container" v-if="!verify">
                <ion-list>
                    <ion-chip>
                        <ion-avatar>
                            <img alt="Silhouette of a person's head" :src="currentUser.avatarUrl" />
                        </ion-avatar>
                        <ion-label>{{ currentUser.email }}</ion-label>
                    </ion-chip>
                    <functional-input inputType="password" v-model="password"></functional-input>
                    <functional-input inputType="password" v-model="confirmPassword"></functional-input>
                    <ion-button @click="editPassword" id="edit-password-alert">
                        editPassword
                    </ion-button>
                    <ion-alert trigger="edit-password-alert" :header="alertHeader" :sub-header="alertSubHeader"
                        :message="alertMessage" :buttons="alertButtons"></ion-alert>
                </ion-list>
            </div>

            <div id="container" v-else>
                <ion-list>
                    <verify-module v-model:code="code" :avatarUrl="currentUser.avatarUrl" :email="targetEmail"
