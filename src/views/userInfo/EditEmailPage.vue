        ...
        <ion-content :fullscreen="true" class="ion-padding">
            ...
            <div id="container" v-if="!verify">
                <ion-list>
                    ...
                    <functional-input inputType="email" v-model="targetEmail"></functional-input>
                    <ion-button @click="editEmail" id="edit-email-alert">
                        editEmail
                    </ion-button>
                    <ion-alert trigger="edit-email-alert" :header="alertHeader" :sub-header="alertSubHeader"
...
import { codeFormat, emailFormat } from "@/utils/useTextFormat";
