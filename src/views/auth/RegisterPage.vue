        ...
        <ion-content :fullscreen="true" class="ion-padding">
            ...
            <div id="container">
                <ion-list>
                    <ion-chip>
                        <ion-avatar>
                            <img alt="Silhouette of a person's head" :src="avatarWebPath" @click="takeAvatar" />
                        </ion-avatar>
                        <ion-label>{{ email }}</ion-label>
                    </ion-chip>
                    <functional-input inputType="email" v-model="email"></functional-input>
                    ...
                    <ion-alert trigger="register-alert" :header="alertHeader" :sub-header="alertSubHeader"
