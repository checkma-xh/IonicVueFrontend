export interface Config {
    ...
    viteUserEmailPath        : string,
    viteUserPasswordPath     : string,
    viteSearchHistoryPath    : string,
    ...
    viteAccessTokenExpiration: number,
    ...
    public static getConfig() {
        if (!ConfigService.config) {
            ConfigService.config = {
                ...
                viteUserEmailPath        : import.meta.env.VITE_USER_EMAIL_PATH || "userEmail",
                viteUserPasswordPath     : import.meta.env.VITE_USER_PASSWORD_PATH || "userPassword",
                viteSearchHistoryPath    : import.meta.env.VITE_SEARCH_HISTORY_PATH || "searchHistory",
                ...
                viteAccessTokenExpiration: parseInt(import.meta.env.VITE_ACCESS_TOKEN_EXPIRATION) || 3600,
