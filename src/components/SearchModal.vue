<template>
    <ion-header>
        ...
        <ion-toolbar>
            <ion-searchbar ref="searchBarRef" placeholder="Search" expand="block" :debounce="10"
                show-clear-button="never" label-placement="floating" v-model.lazy="searchContent"
                @ionInput="handleInput" @ionBlur="handleBlur" @keydown.enter="handleSearch">
            </ion-searchbar></ion-toolbar>
    </ion-header>
    <ion-content class="ion-padding">
        <ion-list>
            <ion-item v-for="(value, index) in results" button :key="index" @click="async () => {
                ...
                <ion-button fill="clear" @click.stop="async () => {
